...
######################################################################
#
# Figure out average point value of omaha8 hands.
#
# $Id$
#
######################################################################
...
print "\tOpeners: %5.2f%% Raisers: %5.2f%% Reraisers: %5.2f%%" % (percent(pointOpeningHands, totalHands),
								  percent(pointRaisingHands, totalHands),
								  percent(pointReraisingHands, totalHands))
print "\tOpeners in a deal: Average %4.1f Max %d" % (1.0 * pointOpeningHands / options.numDeals,
						     maxPointOpeners)
print "Opening Hands by Krieger method: %5.2f%%" % percent(openingHands, totalHands)
